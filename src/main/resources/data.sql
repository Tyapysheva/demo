...
values (0,'3','Свидетельство о рождении'),
(0,'7', 'Военный билет'),
...
insert into office(VERSION,name,address,phone,active,id_org)
values
...
insert into document(version, doc_number,doc_date,id_document_type)
values
(0,'3333','2018-12-01',1),
(0,'3333','2018-12-01',1),
(0,'3333','2018-12-01',3),
...
insert into person(VERSION,first_name,middle_name,second_name,phone,position,identified,id_office,ID_CITIZENSHIP,id_doc)
values
(0,'Михаил','Андреевич','Пупкин','8900155111','менеджер',true,1,1,1),
(0,'Вася','Андреевич','Пупкович','8900255522','менеджер',true,2,1,2),
(0,'Иван','Алексеевич','Пупин','8900355533','менеджер',true,3,1,3),
(0,'Сергей','Алексеевич','Попович','8900455544','менеджер',true,4,1,4),
(0,'Лиза','Сергеевна','Попко','8900533355','менеджер',false,5,1,5),
(0,'Маша','Сергеевна','Брувко','8900533335','менеджер',false,1,1,6),
(0,'Даша','Иннокентьевна','Бривко','8900444555','менеджер',false,2,1,7),
(0,'Катя','Иннокентьевна','Дривко','8900444455','менеджер',false,3,1,8),
(0,'Алиса','Михайловна','Ермилова','8900055555','менеджер',false,4,1,9),
(0,'Денис','Михайлович','Ростропович','8900055055','менеджер',false,6,1,10);
